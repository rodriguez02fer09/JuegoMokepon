...
if (mokepon.nombre === "hipodogue"){
  let hipodogeEnemigo =new  Mokepon('Hipodogue')
} else  if(mokepon.nombre === "Capipepo")
...
function iniciarMapa() {
  ...
  mascotaDeJugadorObjeto = obtenerObjetoMascota(mascotaDeJugadorObjeto);
